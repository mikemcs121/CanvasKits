...
source=Image.open(KIT/'info/assets/simplified/step-6-white-eyes.png').convert('RGB')
...
assert exact, 'Reference PDF image differs from approved white-eye stage 6'
