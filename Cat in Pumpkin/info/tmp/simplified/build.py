...
def stage(c, n, x, y, w, h, border=True):
    ...
    image_path = KIT / ('info/assets/simplified/step-6-white-eyes.png' if n == 6 else f'info/tmp/8x10-artwork/step-{n}.png')
    c.drawImage(str(image_path), x+w*.025, y+h*.12, width=w*.95, height=h*.76)
    if border:
