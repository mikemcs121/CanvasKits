...
ref=WORK/f'{SLUG}-finished-reference-8x10.pdf'
c=canvas.Canvas(str(ref),pagesize=(576,720),pageCompression=1)
c.setTitle('Cat in Pumpkin - simplified finished reference'); c.setAuthor('River and Ridge')
stage(c,6,0,0,576,720,False); c.showPage(); c.save()
...
paragraph(c,'<b>Materials:</b> Preprinted 8 x 10 canvas, acrylic paints, large and small brushes<br/>Water cup, paper towels, palette or paper plate<br/><b>Paints:</b> white, black, red, yellow, blue, brown, orange',32,663,548,small)
