# Starry-night Sunflower supporting files
...
- tmp/organization-repair/: region labels, map and paint groups (`labels.bin`, `regions.json`, `group-assignments.json`) read by project `assets/tools/reference-restoration/build-art.cjs` when rebuilding the master.
- archive/original-square-kit/: the original square kit, preserved intact.
...
Review: Portrait reference and guide rebuilt against existing SVG; original square kit archived intact.
