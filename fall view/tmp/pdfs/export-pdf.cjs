...
const png = fs.readFileSync(path.join(kit, 'assets/fall-view-guide-artwork.png'));
...
const destination=path.join(__dirname,'fall-view-painting-guide-illustrated.pdf');fs.writeFileSync(destination,Buffer.concat(parts));
