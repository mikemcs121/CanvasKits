...
string logoPath=root+"/assets/river-and-ridge-logo-page.png";var logo=new Bitmap(File.Exists(logoPath)?logoPath:ProjectLogo(root));g.DrawImage(logo,437,39,145,145f*logo.Height/logo.Width);
