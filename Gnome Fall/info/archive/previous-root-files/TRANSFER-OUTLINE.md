...
Use [the SVG](output/svg/8x10/gnome-fall-outline-8x10.svg) for vector uploads. It is exactly 8 x 10 inches with transparent background, 2-point lines (0.706 mm), round caps/joins, and #A6A6A6 gray for adults. Matching vector PDFs and transparent 300/600-DPI PNGs are in output/pdf/8x10. Print at Actual size / 100%.
