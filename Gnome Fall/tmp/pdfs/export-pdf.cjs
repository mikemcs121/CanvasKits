...
const png = fs.readFileSync(path.join(kit, 'assets/gnome-fall-guide-artwork.png'));
...
const destination=path.join(__dirname,'gnome-fall-painting-guide-illustrated.pdf');fs.writeFileSync(destination,Buffer.concat(parts));
