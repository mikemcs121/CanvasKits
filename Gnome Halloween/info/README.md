...
- assets/full-portrait/: stage pictures and canonical artwork; tmp/full-portrait/: stage builders (`prepare.cjs`, `build-stages.cjs`) with their regions, masks and prompts.
...
Review: Existing corrected full-height reference and guide reviewed; unchanged.
