...
const png = fs.readFileSync(path.join(kit, 'assets/gnome-halloween-guide-artwork.png'));
...
const destination=path.join(__dirname,'gnome-halloween-painting-guide-illustrated.pdf');fs.writeFileSync(destination,Buffer.concat(parts));
