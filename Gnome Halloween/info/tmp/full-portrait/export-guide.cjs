...
const png = fs.readFileSync(path.join(kit, 'tmp/full-portrait/guide-page.png'));
...
const destination=path.join(__dirname,'gnome-halloween-painting-guide-8x10.pdf');fs.writeFileSync(destination,Buffer.concat(parts));
