...
final_target = ASSETS / f"{SLUG}-final-step-7-black-paws.png"
if not final_target.exists():
    raise RuntimeError("Run black-paws-layer.py before building the PDFs")
...
pdf.setTitle("Autumn Fox - simplified black-paws finished reference")
