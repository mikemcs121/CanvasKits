...
foreach($folder in @('Fox Fall','Ghost Fall','Kat In Pumpkin','pumpkin')){
 $d=Join-Path (Get-Location) ($folder+'/tmp/8x10-artwork');$out=Join-Path (Get-Location) ($folder+'/output/pdf/8x10');$checks=@()
