...
foreach($folder in @('Gnome Halloween','Gnome Christmas Tree','Gnome Fall','Flowers in Vase','Fall View','Starry-night Sunflower','Fox Fall','Ghost Fall','Kat In Pumpkin','Pumkin')){
